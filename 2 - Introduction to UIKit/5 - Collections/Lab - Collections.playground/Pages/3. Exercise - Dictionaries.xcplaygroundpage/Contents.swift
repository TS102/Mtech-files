...
if let dayInJan = daysInMonth["January"] {
    print("january has \(dayInJan) days")
}

//:  Given the following arrays, create a new [String : [String]] dictionary. `shapesArray` should use the key "Shapes" and `colorsArray` should use the key "Colors." Print the resulting dictionary.
var shapesArray = ["Triangle", "square", "circle", "rectangle"]
var colorsArray = ["red", "green", "blue", "purple"]
var shapesDicionary = ["Shapes": shapesArray]
var colorsDictionary = ["Colors": colorsArray]
print(colorsDictionary.keys)
colorsDictionary["Colors"]?[1]
...
if let color = colorsDictionary["Colors"]?[1] {
    print(color)
}

print(colorsDictionary["Colors"]![1])
/*:
