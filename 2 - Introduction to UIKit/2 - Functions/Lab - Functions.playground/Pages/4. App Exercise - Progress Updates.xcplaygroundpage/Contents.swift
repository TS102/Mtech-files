...
print(progressUpdate(steps: 233, goal: 10_000))
print(progressUpdate(steps: 4000, goal: 10_000))
...
func pacing(currentDistance: Double, totalDistance: Double, currenTime: Double, goalTime: Double) {
    if totalDistance / currenTime == goalTime {
        print("keep it up!")
    } else {
        print("You've got to push it just a bit harder")
    }
}
pacing(currentDistance: 12, totalDistance: 32, currenTime: 34, goalTime: 23)
/*:
