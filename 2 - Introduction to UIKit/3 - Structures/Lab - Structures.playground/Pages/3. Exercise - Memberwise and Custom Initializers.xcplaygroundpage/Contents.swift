...
let favoriteBook = Book(title: "Michael vey", author: "Richard Paul Evans", pages: 324, price: 8.49)
print("My other favorite book is \(favoriteBook.title) by \(favoriteBook.author) is has \(favoriteBook.pages) pages and costs \(favoriteBook.price) dollars")
/*:
...
let macbook = Laptop(screenSize: 15, repairCount: 2, yearPurchased: 2020)
print(macbook)
let windows = Laptop(screenSize: 16, repairCount: 1, yearPurchased: 2019)
print(windows)
/*:
...
struct Height{
    ...
    init(Inches: Double, Centimeters: Double){
        self.Inches = Inches
        self.Centimeters = Inches * Centimeters
    }
}
...
var someonesHeight = Height(Inches: 65, Centimeters: 2.54)
print("heigh in inches is \(someonesHeight.Inches) and in centimeters it is \(someonesHeight.Centimeters)")
...
var myHeight = Height(Inches: 71, Centimeters: 2.54)
print(myHeight)
print("My height is five eleven but in inches it is \(myHeight.Inches) my height in centimeters is \(myHeight.Centimeters)")
/*:
