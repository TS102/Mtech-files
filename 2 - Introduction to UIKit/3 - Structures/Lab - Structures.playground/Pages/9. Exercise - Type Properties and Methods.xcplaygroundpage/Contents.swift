...
struct User {
    ...
    var email: String
    var age: Int
    static var currrentUser = User(userName: "Tyler", email: "tyler@mail", age: 19)
    static var logIn = currrentUser
}
print(User.currrentUser)
 ...
 */
print("user \(User.logIn.userName) has loggd in")
