...
var tyler = User(name: "Tyler", age: 19, height: 5.11, weight: 165, activityLevel: 7)
print("Users name is \(tyler.name) age: \(tyler.age) weight: \(tyler.weight) activity today: \(tyler.activityLevel)")
...
var mile = Distance(meters: 1600, feet: 3.28084)
print(mile.feet)
//:  Now create another instance of `Distance` and give it some other distance. Ensure that both properties are set correctly.
var trek = Distance(meters: 7238, feet: 3.28084)
print(trek.feet)
/*:
