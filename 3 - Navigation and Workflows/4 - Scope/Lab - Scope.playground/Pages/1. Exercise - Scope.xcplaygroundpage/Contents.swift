...
//foo is inside of the for loop so you can't pull it out
...
// the print statement inside of the loop prints becuase it pulls from the var x
// the second statement print works because var x is outside of the for loop it changes because the for loop added to the value
...
let jeep = Car(make: "Jeep", model: "Wrangler", year: 2022)
/*:
