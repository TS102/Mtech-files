...
// it say i cannot convert the string into an int becuase it is not an optional
...
print(userAge)
print("I think that it prints nil is because it became an optional and i turned the string into a int but because the string has a letter it makes it nil")
