...
print(addedHRD)
print("It differs from the original average because it is a double and so it should show a more accurate number because we are adding up a bunch of numbers that could come out at a odd number.")
