...
print("I think it will result in a whole number insted of a decimal")
...
let odd = 77
print(odd / 2)
print("I don't think you can really tell which one was the odd number because if you divide a whole number thats odd no matter what swift will assume it is a Int so it won't print any decimals")
/*:
